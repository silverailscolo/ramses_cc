...
Test-release 0.57.6. Update advised if you run 0.56.7-0.57.5 - Requires HA Core 2026.5.0 or later. Uses config format V2 since 0.56.3. For CH/evohome on production system, stick with 0.55.3, testers invited).
