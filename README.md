...
Test-release 0.57.9. Update advised if you run 0.56.7-0.57.8. CH/evohome requires a full schema entered in Config. - Requires HA Core 2026.5.0 or later. Uses config format V2 since 0.56.3.
