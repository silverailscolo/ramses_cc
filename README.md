...
Test-release 0.57.1. Update advised if you run 0.56.7-0.57.0 - Requires HA Core 2026.5.0 or later. Uses config format V2 since 0.56.3. For evohome, see issue #666/stick with 0.55.3.
