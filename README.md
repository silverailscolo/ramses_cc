...
Test-release 0.57.8. Update advised if you run 0.56.7-0.57.7. CH/evohome testers invited. - Requires HA Core 2026.5.0 or later. Uses config format V2 since 0.56.3.
